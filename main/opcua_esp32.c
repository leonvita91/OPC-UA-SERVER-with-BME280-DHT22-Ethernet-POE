...
{
    ESP_LOGI(TAG_BME280, "connection_scan start");
    ESP_ERROR_CHECK(esp_netif_init());
    ESP_LOGI(TAG_BME280, "connection_scan esp_netif_init");
    ESP_ERROR_CHECK(esp_event_loop_create_default());
    ESP_LOGI(TAG_BME280, "connection_scan esp_event_loop_create_default");
    ESP_ERROR_CHECK(esp_task_wdt_init(10, true));
    ESP_LOGI(TAG_BME280, "connection_scan esp_task_wdt_init");
...
{
    ESP_LOGI(TAG_BME280, "i2c_master_init");
    ...
    ESP_LOGI(TAG_BME280, "i2c_master_init config");
	i2c_driver_install(I2C_NUM_0, I2C_MODE_MASTER, 0, 0, 0);
    ESP_LOGI(TAG_BME280, "i2c_master_init driver install");
}
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG_BME280, "app_Main scan start");
    connection_scan();
    ESP_LOGI(TAG_BME280, "app_Main scan end");
